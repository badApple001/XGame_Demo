...
{
    public abstract class NetVisibleEntity : VisibleEntity, INetEntity
    {
        ...
        protected override void OnAfterInit(object context)
        {
            ...
            if (shareCtx != null && shareCtx.netInitContext != null && shareCtx.netInitContext.netDataSerializer != null)
            {
