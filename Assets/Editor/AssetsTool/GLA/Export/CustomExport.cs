...
//        //打包资源
//        [MenuItem("XGame/Build/Android/Export Package")]
...
//        [MenuItem("XGame/Build/Android/Generate List for All Packages")]
...
//        [MenuItem("XGame/Build/Iphone/Export Package")]
...
//        //generate resource list
//        [MenuItem("XGame/Build/Iphone/Generate List for All Packages")]
...
//        //打包资源
//        [MenuItem("XGame/Build/WebPlayer/Export Package")]
...
//        //generate resource list
//        [MenuItem("XGame/Build/WebPlayer/Generate List for All Packages")]
...
//                    EditorApplication.OpenScene(SrcSubFullPath);
...
//                    EditorApplication.OpenScene(TempFullLevel1);

//                    while (true)
//                    {
//                        EditorApplication.Step();
//                        if (Path.GetFileNameWithoutExtension(EditorApplication.currentScene) == Path.GetFileNameWithoutExtension(SrcSubFullPath))
//                        {
//                            break;
//                        }
//                    }
...
//                    BuildPipeline.BuildStreamedSceneAssetBundle(levels, scenepkgpath, platform);
//                    {
...
//                    XGame.CsvReader.ScpReader oldpackagecfg = new XGame.CsvReader.ScpReader(oldpackagecfgtext, "oldpackagelist");
...
//                        }
//                        string key = packname + "*^$@&%#!";
//                        byte[] outputdata = ResUtil.EncryptDES(inputdata, key);
//                        if (outputdata == null)
//                        {
//                            continue;
//                        }
