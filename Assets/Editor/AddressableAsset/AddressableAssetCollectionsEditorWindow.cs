...
{
    class AddressableAssetCollectionsEditorWindow : EditorWindow
    {
        [MenuItem("XGame/配置资源/创建编址资源")]
        public static void CreateAssetCollections()
        {
            AddressableAssetCollectionsEditorWindow window = GetWindow<AddressableAssetCollectionsEditorWindow>();
        ...
        private void OnEnable()
        {
            ...
            XGameEditorUtilityEx.FindAllRawGenericSubClassTypes(typeof(XGame.Utils.AddressableAssetCollections<>), m_lsTypes);
        }
