    ...
    public partial class StaticLuaCallbacks
    {
        ...
        public static int ToFunction(RealStatePtr L)
        {
            try
            {
                ...
                MethodWrapsCache.s_ListTemp.Add(m);

                translator.PushFixCSFunction(L,
                        new LuaCSFunction(translator.methodWrapsCache._GenMethodWrap(m.DeclaringType, m.Name, MethodWrapsCache.s_ListTemp).Call));
                return 1;
            }
            catch (Exception e)
            {
        ...
        public static int GenericMethodWraper(RealStatePtr L)
        {
            try
            {
                ...
                translator.PushFixCSFunction(L,
                        new LuaCSFunction(translator.methodWrapsCache._GenMethodWrap(method.DeclaringType, method.Name, MethodWrapsCache.s_ListTemp).Call));
                return 1;
            }
            catch (Exception e)
            {
