...
namespace XLua
{
    ...
    public class LuaEnv : IDisposable
    {
        ...
        //错误捕捉函数
        public delegate void ErrorCallback(string stackTrace);
        static public ErrorCallback errorCallBack = null;        internal RealStatePtr L
        {
            get
            {
...
#if UNITY_EDITOR
            ReflectionMonitor.Instance().Save();
#endif
            FullGc();
            System.GC.Collect();
