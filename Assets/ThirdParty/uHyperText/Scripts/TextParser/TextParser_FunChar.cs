...
namespace WXB
{
    ...
    public partial class TextParser
    {
        ...
        void ParserCartoon(string text)
        {
            ...
            cn.cartoon = cartoon;
            cn.width = cartoon.width * currentConfig.cartonScale;
            cn.height = cartoon.height * currentConfig.cartonScale;
