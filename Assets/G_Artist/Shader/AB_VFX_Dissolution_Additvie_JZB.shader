...
////// Emissive:
                ...
                float3 emissive = (_Texture_var.rgb*i.vertexColor.rgb*(_Texture_var.a*_Color.a*i.vertexColor.a*smoothstep( (1.0 - _Smooth), _Smooth, saturate((_Dissolve_var.r+1.0+(1.0 - _Out)+i.vertexColor.a)) ))*_Color.rgb);
