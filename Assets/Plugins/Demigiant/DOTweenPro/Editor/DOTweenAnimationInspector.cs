...
//            _src.isValid = Validate(); // Moved down
            ...
            if (playMode) {
                ...
                GUILayout.BeginHorizontal();
                bool hasManager = HasVisualManager();
            ...
            //set template id 
            _src.templateID = EditorGUILayout.IntField(new GUIContent("Template ID", "Set then template id to animation，zero means invalid "), _src.templateID);

            //set backward flag
            _src.playBackward = DeGUILayout.ToggleButton(_src.playBackward,"play backward tween");
            _src.recover = DeGUILayout.ToggleButton(_src.recover, "recover change");
...
//                _src.animationType = (DOTweenAnimation.AnimationType)EditorGUILayout.EnumPopup(_src.animationType, EditorGUIUtils.popupButton);
        ...
        protected virtual bool HasVisualManager()
        {
            return _src.GetComponent<DOTweenVisualManager>() != null;
        }

        protected virtual void AddVisualManager()
        {
