...
public class BuglyInit : MonoBehaviour
{
    ...
    /// 
	//安卓ID
	public  string BuglyAndroidAppID = "8db1a05b2a";

    //苹果ID
    public  string BuglyIOSAppID = "6d6179acf7";
    ...
    void Awake ()
	{
		...
		//BuglyAgent.ConfigAutoReportLogLevel (0);
...
#if UNITY_ANDROID
        BuglyAgent.InitWithAppId (BuglyAndroidAppID);
#else
        BuglyAgent.InitWithAppId (BuglyIOSAppID);
#endif
